...
export function showPaintingEditButtons(mesh, scene, camera, controls, quill) {
  ...
  resizeBtn.innerHTML = `<img src="public/icons/editSize.svg" alt="크기조절" />`
  ...
  if (mesh.userData.isPainting && !mesh.userData.type?.startsWith("intro") && mesh.userData.type !== 'poster') {
    ...
    storyBtn.innerHTML = `<img src="public/icons/editText.svg" alt="작품이야기" />`
  ...
  if (mesh.userData.isPainting && !mesh.userData.type?.startsWith("intro") && mesh.userData.type !== 'poster') {
    ...
    // 상태별 아이콘 경로
    const ICON_ON  = "public/icons/navInfo.svg"
    const ICON_OFF = "public/icons/navInfoOff.svg"
  ...
  if (mesh.userData.type === "intro-frame" && getIntroMode()) {
    ...
    colorBtn.innerHTML = `<img src="public/icons/editColor.svg" alt="프레임색상" />`
  ...
  if (isIntro && getIntroMode()) {
    ...
    editTextBtn.innerHTML = `<img src="public/icons/editText.svg" alt="텍스트입력" />`
  ...
  if (mesh.userData.type === 'poster') {
    ...
    uploadBtn.innerHTML = `<img src="public/icons/editPoster.svg" alt="포스터 올리기" />`
  ...
  deleteBtn.innerHTML = `<img src="public/icons/editDelete.svg" alt="삭제" />`
  deleteBtn.onclick = () => {
